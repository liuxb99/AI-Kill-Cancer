...
from src.backend.api.v1.ptc_data_quality import router as ptc_data_quality_router
from src.backend.api.v1.ptc_evidence_matrix import router as ptc_evidence_matrix_router
...
from src.backend.api.v1.ptc_research_depth import router as ptc_research_depth_router
...
router.include_router(ptc_research_depth_router)
...
router.include_router(ptc_visualization_router)
