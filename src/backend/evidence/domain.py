...
from sqlalchemy import Column, String, Float, Text, DateTime, JSON, Enum as SAEnum, ForeignKey
...
class EvidenceItemModel(DBBase):
    ...
    evidence_level = Column(String(32), nullable=True, comment="A, B, C, D, E or Level_1-5")
